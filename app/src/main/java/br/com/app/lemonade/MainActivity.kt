 ...
 */
package br.com.app.lemonade

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.ImageView
import android.widget.TextView
import br.com.app.lemonade.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val lemonadeImageView: ImageView = findViewById(R.id.image_lemon_state)
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                lemonadeImageView.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonadeImageView.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                textAction.setText(R.string.lemon_drink)
                lemonadeImageView.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.setText(R.string.lemon_empty_glass)
                lemonadeImageView.setImageResource(R.drawable.lemon_restart)
            }
        }
    }
